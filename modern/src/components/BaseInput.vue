...
<template>
  <div class="flex flex-col gap-1">
    ...
    <input
      ...
      :disabled="disabled"
      class="px-3 py-2.5 min-h-[44px] rounded-lg border text-sm bg-white dark:bg-surface-input text-text-primary dark:text-white placeholder:text-text-muted outline-none transition-colors
