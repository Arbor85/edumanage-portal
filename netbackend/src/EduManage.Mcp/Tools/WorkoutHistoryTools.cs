...
[McpServerToolType]
public sealed class WorkoutHistoryTools(ISender sender, IOptions<McpSettings> settings)
{
    ...
    public async Task<string> ListWorkoutHistory(
        [Description("Optional start date filter in ISO 8601 format, e.g. 2026-01-01T00:00:00")] string? from,
        [Description("Optional end date filter in ISO 8601 format, e.g. 2026-12-31T23:59:59")] string? to,
