...
public sealed class ListPlansHandler(IPlanRepository repository) : IRequestHandler<ListPlansQuery, IReadOnlyList<PlanOut>>
{
...
public sealed class AddPlanHandler(IPlanRepository repository) : IRequestHandler<AddPlanCommand, PlanOut>
{
...
public sealed class GetPlanHandler(IPlanRepository repository) : IRequestHandler<GetPlanQuery, PlanOut>
{
...
public sealed class UpdatePlanHandler(IPlanRepository repository) : IRequestHandler<UpdatePlanCommand, PlanOut>
{
...
public sealed class DeletePlanHandler(IPlanRepository repository) : IRequestHandler<DeletePlanCommand, Dictionary<string, string>>
{
...
public sealed class UpdatePlanStatusHandler(IPlanRepository repository) : IRequestHandler<UpdatePlanStatusCommand, PlanOut>
{
