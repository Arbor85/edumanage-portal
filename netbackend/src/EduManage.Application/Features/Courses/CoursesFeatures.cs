...
public sealed class ListCoursesHandler(ICourseRepository repository) : IRequestHandler<ListCoursesQuery, IReadOnlyList<CourseOut>>
{
...
public sealed class AddCourseHandler(ICourseRepository repository) : IRequestHandler<AddCourseCommand, CourseOut>
{
...
public sealed class UpdateCourseHandler(ICourseRepository repository) : IRequestHandler<UpdateCourseCommand, CourseOut>
{
...
public sealed class DeleteCourseHandler(ICourseRepository repository) : IRequestHandler<DeleteCourseCommand, Dictionary<string, string>>
{
